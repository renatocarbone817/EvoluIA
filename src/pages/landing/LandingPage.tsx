...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] text-[#0F172A] font-sans antialiased selection:bg-[#7C3AED] selection:text-white overflow-x-hidden">
      {/* =========================================================================
          1. HEADER / NAVBAR FIXA (CLEAN LIGHT DESIGN)
          ========================================================================= */}
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-100 transition-all shadow-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          >
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-[#6366F1] to-[#7C3AED] flex items-center justify-center text-white shadow-md shadow-purple-500/20 group-hover:scale-105 transition-all">
          ...
          <div className="hidden sm:flex items-center gap-3">
            {user ? (
              <button
                ...
                className="px-4 py-2.5 rounded-2xl bg-[#F1F5F9] hover:bg-[#E2E8F0] text-[#0F172A] text-xs font-black border border-slate-200 transition-all active:scale-95 cursor-pointer"
              >
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-2xl text-xs font-bold text-[#475569] hover:text-[#0F172A] hover:bg-slate-50 transition-all cursor-pointer"
              >
            ...
            <a
              href="#planos"
              className="px-5 py-2.5 rounded-2xl bg-[#7C3AED] hover:bg-[#6D28D9] text-white text-xs font-black shadow-md shadow-purple-500/20 hover:shadow-lg hover:shadow-purple-500/30 transition-all active:scale-95 flex items-center gap-1.5 cursor-pointer"
            >
          ...
          <button
            ...
            className="sm:hidden p-2 rounded-xl bg-slate-100 text-slate-700"
          >
        ...
        {/* Mobile Dropdown */}
        {mobileMenuOpen && (
          <div className="sm:hidden bg-white border-b border-slate-200 px-4 py-6 space-y-4 shadow-xl">
      ...
      {/* =========================================================================
          ...
          ========================================================================= */}
      <section className="relative pt-12 pb-20 lg:pt-20 lg:pb-32 overflow-hidden bg-gradient-to-b from-purple-50/40 via-white to-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-10 text-center">
          {/* Top Pill Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-100/80 border border-purple-200/80 shadow-xs text-xs font-black text-[#7C3AED]">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
            ...
            <a
              href="#simulador"
              className="w-full sm:w-auto px-6 py-4 rounded-3xl bg-white hover:bg-slate-50 border-2 border-slate-200 text-[#334155] hover:text-[#0F172A] text-sm font-bold transition-all active:scale-95 flex items-center justify-center gap-2 shadow-xs"
            >
          ...
          {/* =========================================================================
              LIVE INTERACTIVE APP PREVIEW (CLEAN LIGHT THEME FRAME)
              ========================================================================= */}
          <div className="pt-8 max-w-5xl mx-auto">
            <div className="rounded-3xl sm:rounded-[36px] bg-slate-900/5 p-2 sm:p-3 shadow-2xl border border-slate-200/80 backdrop-blur-xl">
              <div className="rounded-2xl sm:rounded-[30px] bg-white border border-slate-200 overflow-hidden text-left shadow-lg">
                {/* Mockup Header Bar */}
                      ...
                      return (
                        <button
                          ...
                          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl transition-all cursor-pointer ${
                            isActive
                              ? "bg-white text-[#7C3AED] shadow-sm font-black scale-102"
                    ...
                    <div className="space-y-5 animate-in fade-in">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-2xl bg-purple-100 text-[#7C3AED] flex items-center justify-center font-black">
                            🤖
                          </div>
                          <div>
                        ...
                        <span className="px-3 py-1 rounded-full text-[11px] font-black bg-emerald-100 text-emerald-800 border border-emerald-200 self-start sm:self-auto">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                        ...
                        <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-2">
                          ...
                          <p className="text-slate-700 font-mono text-[11px] leading-relaxed bg-white p-3 rounded-xl border border-slate-200">
                        ...
                        <div className="p-4 rounded-2xl bg-purple-50/60 border border-purple-200 space-y-2">
                          ...
                          <p className="text-slate-800 font-medium text-[11px] leading-relaxed bg-white p-3 rounded-xl border border-purple-100 shadow-xs">
                  ...
                  {interactiveTab === "whatsapp" && (
                    <div className="space-y-5 animate-in fade-in">
                      ...
                      <div className="max-w-md mx-auto p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-3">
                        <div className="p-4 rounded-2xl bg-[#DCF8C6] text-[#075E54] text-xs font-medium space-y-2 shadow-xs">
                    ...
                    <div className="space-y-5 animate-in fade-in">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
                        <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-1">
                          <span className="text-[10px] font-extrabold text-sky-700 uppercase">HISTÓRICO</span>
                        ...
                        <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-1">
                          <span className="text-[10px] font-extrabold text-purple-700 uppercase">PLANO DE ENSINO</span>
                          <p className="font-black text-[#0F172A]">PEI Integrado</p>
                          <p className="text-[11px] text-slate-600">Metas e objetivos por período</p>
                        </div>
                        <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-1">
                          <span className="text-[10px] font-extrabold text-emerald-700 uppercase">DOCUMENTOS</span>
                    ...
                    <div className="space-y-5 animate-in fade-in">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
                        <div className="p-4 rounded-2xl bg-emerald-50 border border-emerald-200">
                          ...
                          <p className="text-lg font-black text-emerald-900 mt-0.5">R$ 6.840,00</p>
                        </div>
                        <div className="p-4 rounded-2xl bg-amber-50 border border-amber-200">
                          <p className="text-[10px] text-amber-700 font-bold">PENDENTE</p>
                          <p className="text-lg font-black text-amber-900 mt-0.5">R$ 480,00</p>
                        </div>
                        <div className="p-4 rounded-2xl bg-sky-50 border border-sky-200">
                          <p className="text-[10px] text-sky-700 font-bold">FORMA FAVORITA</p>
                          <p className="text-lg font-black text-sky-900 mt-0.5">92% PIX</p>
                        </div>
                        <div className="p-4 rounded-2xl bg-purple-50 border border-purple-200">
                          <p className="text-[10px] text-purple-700 font-bold">INADIMPLÊNCIA</p>
                          <p className="text-lg font-black text-purple-900 mt-0.5">0% (Zero)</p>
                        </div>
                      </div>
                    </div>
                  )}
      ...
      {/* =========================================================================
          ...
          ========================================================================= */}
      <section id="comparativo" className="py-20 lg:py-32 bg-slate-50 border-y border-slate-200 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 items-stretch">
            {/* Lado 1: Sem EvoluIA */}
            <div className="p-6 sm:p-8 rounded-3xl bg-white border-2 border-red-200 shadow-sm space-y-6">
              <div className="flex items-center gap-3">
            ...
            {/* Lado 2: Com EvoluIA */}
            <div className="p-6 sm:p-8 rounded-3xl bg-white border-2 border-emerald-300 shadow-xl shadow-emerald-500/10 space-y-6">
              <div className="flex items-center gap-3">
      ...
      <section id="recursos" className="py-20 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Pilar 1 */}
            <div className="p-6 rounded-3xl bg-slate-50 border border-slate-200 hover:border-purple-300 hover:shadow-lg transition-all space-y-4 group">
              <div className="w-12 h-12 rounded-2xl bg-purple-100 text-[#7C3AED] flex items-center justify-center group-hover:scale-110 transition-transform">
            ...
            {/* Pilar 2 */}
            <div className="p-6 rounded-3xl bg-slate-50 border border-slate-200 hover:border-emerald-300 hover:shadow-lg transition-all space-y-4 group">
            ...
            {/* Pilar 3 */}
            <div className="p-6 rounded-3xl bg-slate-50 border border-slate-200 hover:border-sky-300 hover:shadow-lg transition-all space-y-4 group">
            ...
            {/* Pilar 4 */}
            <div className="p-6 rounded-3xl bg-slate-50 border border-slate-200 hover:border-amber-300 hover:shadow-lg transition-all space-y-4 group">
      ...
      {/* =========================================================================
          ...
          ========================================================================= */}
      <section id="simulador" className="py-20 lg:py-32 bg-purple-50/50 border-t border-slate-200 relative">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="p-6 sm:p-10 rounded-3xl bg-white border-2 border-slate-200/80 shadow-xl space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-slate-700">Quantos pacientes você atende na semana?</span>
                <span className="text-2xl font-black text-[#7C3AED] bg-purple-100 px-4 py-1 rounded-2xl border border-purple-200">
              ...
              <input
                ...
                className="w-full h-3 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-[#7C3AED]"
              />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-slate-100">
              <div className="p-5 rounded-2xl bg-emerald-50 border border-emerald-200 text-center sm:text-left space-y-1">
              ...
              <div className="p-5 rounded-2xl bg-purple-50 border border-purple-200 text-center sm:text-left space-y-1">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          <div className="text-center space-y-4 max-w-3xl mx-auto">
            ...
            <div className="pt-4 flex items-center justify-center gap-3">
              <span className={`text-xs font-bold ${billingPeriod === "monthly" ? "text-slate-900" : "text-slate-500"}`}>
                Mensal
              </span>
              <button
              ...
              <span className={`text-xs font-bold flex items-center gap-1 ${billingPeriod === "yearly" ? "text-slate-900" : "text-slate-500"}`}>
                <span>Anual</span>
              ...
              return (
                <div
                  ...
                  className={`relative rounded-3xl p-5 flex flex-col justify-between transition-all border-2 ${
                    isPopular
                      ? "bg-gradient-to-b from-purple-50/70 to-white border-[#7C3AED] shadow-xl ring-2 ring-purple-400/20 scale-102"
                ...
                >
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-[11px] text-slate-600 mt-1 leading-snug">{plan.description}</p>
                    </div>
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full p-5 text-left flex items-center justify-between gap-4 font-black text-sm text-[#0F172A] cursor-pointer hover:bg-slate-100/80"
                  >
                    <span>{faq.q}</span>
                    {isOpen ? (
                  ...
                  {isOpen && (
                    <div className="px-5 pb-5 text-xs text-slate-600 leading-relaxed border-t border-slate-200/60 pt-3 animate-in fade-in font-medium">
                      {faq.a}
                    </div>
                  )}
                </div>
