...
export function PlanPage() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-[1520px] mx-auto space-y-8">
      {/* 1. CABEÇALHO */}
      ...
      <div className="space-y-6">
        ...
        {/* Monthly / Yearly Toggle - Centralizado perfeitamente no meio acima dos 5 planos */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2 pb-1">
          ...
          <div className="flex items-center gap-3 p-1.5 rounded-2xl bg-white border-2 border-[#D8E5E7] shadow-xs">
            <span
